...
# OK, so I should be able to create an arbitrary correlation value
# There should be a simple way to create pairs of variables which on average, are 0.8 correlated
